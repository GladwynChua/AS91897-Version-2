...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.canvas = Canvas(width=1000, height=300)
    ...
    def display_title(self):
        ...
        # Title
        title = Label(self.window, text="General Knowledge Quiz",
                      width=82,height=3, bg="#512E5F", fg="white", font=("ariel", 20, "bold"))
    ...
    def radio_buttons(self):
        ...
        while len(choice_list) < 4:
            ...
            # placing the button
            if i == 0:
                radio_btn.place(x=120, y=280)
            elif i == 1:
                radio_btn.place(x=800, y=280)
            elif i == 2:
                radio_btn.place(x=120, y=450)
            elif i == 3:
                radio_btn.place(x=800, y=450)
    ...
    def next_btn(self):
        ...
        if self.quiz.check_answer(self.user_answer.get()):
            ...
            self.feedback.place(x=300, y=600)
    ...
    def buttons(self):
        ...
        next_button.place(x=1150, y=650)
        ...
        quit_button.place(x=1240, y=110)
